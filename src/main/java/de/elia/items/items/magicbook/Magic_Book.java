    ...
    public Magic_Book(Plugin plugin) {
        if (MB == null) {
            ...
            MB = TheZepserAPI.Item.create(Material.BOOK, name, list)
                    ...
                    .setAmount(1)
                    .addAttribute(Attribute.GENERIC_MAX_HEALTH, 20.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.HAND)
                    .addAttribute(Attribute.GENERIC_MAX_HEALTH, 20.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.OFF_HAND)
